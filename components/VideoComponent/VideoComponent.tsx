...
const VideoComponent = (props: Props) => {
	...
	return (
		<div className='relative w-full gap-8 min-h-[130vh] px-[5vw] grid grid-cols-4 bg-gray-200 overflow-hidden grid-rows-[auto_auto_1fr] py-10'>
			{' '}
			<div className='z-10 mt-4 col-start-1 col-span-3 flex flex-col row-start-1 max-h-max'>
				<GSAPSplitTextComponent
					...
					<p className='text-5xl text-medium leading-tight tracking-tighter'>
						...
						autem expedita, perferendis iusto.
					</p>
				</GSAPSplitTextComponent>
			</div>
