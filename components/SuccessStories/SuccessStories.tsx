...
const SuccessStories = (props: Props) => {
	...
	return (
		<>
			<GFBMarquee />
			<div className='w-full min-h-screen bg-(--black) pt-8 pb-[5vw] flex flex-col'>
				<div className='grid grid-cols-[5vw_repeat(4,minmax(0,1fr))_5vw] w-full overflow-hidden'>
					<div className='col-start-1 col-span-2 w-full flex flex-col px-[5vw] pt-24 pb-4 bg-gray-300 rounded-xl'>
						...
						<p
							className='mt-auto tracking-tighter max-w-xs'
							style={{ fontFamily: 'Lora, serif' }}>
							"Strength does not come from physical capacity. It comes from an
							indomitable will." – Mahatma Gandhi
						</p>
					</div>
					<div className='relative w-full h-[800px] col-start-3 col-span-4 md:col-start-3 overflow-hidden rounded-xl'>
						<Image
						...
						<div className='grid w-full grid-cols-[repeat(4,1fr)] absolute bottom-4 right-0 z-30'>
							<div className='flex gap-2 col-span-full col-start-2 md:col-start-2 -col-end-2 w-full overflow-hidden'>
								<div
									onClick={() => handleActiveStoryChange(0)}
									className='w-24 md:w-48 h-24 md:h-40 bg-[#171717] rounded-lg flex relative flex-1 overflow-hidden'>
									<Image
