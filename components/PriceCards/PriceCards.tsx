		...
		<div
			...
			<div className='w-[90vw] mx-auto min-h-1/2 flex flex-col items-center gap-4 md:gap-8'>
				<GSAPSplitTextComponent ease={'power2'}>
					<h2
						className={`text-2xl md:text-5xl tracking-normal max-w-[25ch] leading-[1.3] ${
							activeIndex === 0 ? 'text-[#b59c6c]' : 'text-[#b59c6c]'
						} text-center`}
				...
				<button
					...
					<span
						className={`absolute w-1/2 h-full flex bg-[#b59c6c] rounded-full border border-[#b59c6c] z-0 transition-all duration-300 ease-out transform ${
